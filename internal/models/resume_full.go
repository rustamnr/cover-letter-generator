...
func (r *ResumeFull) getBasicInfo() string {
...
func (r *ResumeFull) getLocationInfo() string {
	return fmt.Sprintf("Местоположение: %s\n", r.Area.Name)
}

func (r *ResumeFull) getContactInfo() string {
	var sb strings.Builder
...
func (r *ResumeFull) getContactText(contact Contact) string {
...
func (r *ResumeFull) getWorkExperienceInfo() string {
	var sb strings.Builder
...
func (r *ResumeFull) getEducationInfo() string {
	var sb strings.Builder
...
func (r *ResumeFull) getSalaryInfo() string {
